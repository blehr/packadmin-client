...
export default function (state = { allScouts: [], advData: {}, advDen: 'Tiger' }, action) {
  switch (action.type) {
    case GET_ALL_SCOUTS:
    ...
    case SCOUT_DETAIL:
      ...
      return { ...state, allScouts: [action.payload], advDen: action.payload.den, advData: action.payload[actionTitle] };
    case GET_SCOUT_FROM_ALL:
      ...
      return { ...state, allScouts: newScout, advDen: newScout[0].den, advData: newScout[0][title] };
    case DEN_ADV_DATA:
