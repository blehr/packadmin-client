    ...
    return (
      ...
      <div className="col-sm-4">
          ...
          <fieldset>
            <legend>Scout Info</legend>
            <div className="form-group">
              <Field name="picturesAllowed" component={Checkbox} label="Allow Pictures" iconStyle={{fill: indigo500}} />
              <Field name="dues" component={Checkbox} label="Dues Paid" iconStyle={{fill: indigo500}} />
              <Field name="book" component={Checkbox} label="Book Received" iconStyle={{fill: indigo500}} />
              <Field name="boat" component={Checkbox} label="Boat Received" iconStyle={{fill: indigo500}} />
              <Field name="car" component={Checkbox} label="Car Received" iconStyle={{fill: indigo500}} />
      ...
      <div className="col-sm-4">
          ...
          <fieldset>
            ...
            <div className="form-group">
              <Field name="parent1AddressSameAsScout" component={Checkbox} label="Address same as Scout" iconStyle={{fill: indigo500}} />
      ...
      <div className="col-sm-4">
          ...
          <fieldset>
            ...
            <div className="form-group">
              <Field name="parent2AddressSameAsScout" component={Checkbox} label="Address same as Scout" iconStyle={{fill: indigo500}} />
      ...
      <div className="form-buttons-container">
        ...
        <RaisedButton type="button" disabled={this.props.pristine || this.props.submitting} secondary={true}  onClick={this.props.reset} label="Reset" style={style} />
      </div>
...
const mapStateToProps = function({ editScout }) {
    return {  initialValues: editScout };
};

const mapDispatchToProps = function(dispatch) {
    return bindActionCreators({  addScoutResponseAction, updateScout, getScoutToUpdate, clearUpdateScout }, dispatch);
};
